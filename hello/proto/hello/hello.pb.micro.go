...
type HelloService interface {
	Helloo(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
...
func (c *helloService) Helloo(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Hello.Helloo", in)
	out := new(Response)
...
type HelloHandler interface {
	Helloo(context.Context, *Request, *Response) error
...
func RegisterHelloHandler(s server.Server, hdlr HelloHandler, opts ...server.HandlerOption) error {
	type hello interface {
		Helloo(ctx context.Context, in *Request, out *Response) error
...
func (h *helloHandler) Helloo(ctx context.Context, in *Request, out *Response) error {
	return h.HelloHandler.Helloo(ctx, in, out)
}
